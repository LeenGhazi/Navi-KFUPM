...
type LoginType = 'user' | 'admin' | 'technical_admin' | null;
        ...
        {loginType === null ? (
          ...
          <div className="space-y-3">
            ...
            <Button
              variant="outline"
              className="w-full h-auto py-4 flex items-center gap-3 justify-start"
              onClick={() => setLoginType('technical_admin')}
            >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="your.email@kfupm.edu.sa"
                value={email}
            ...
            <div className="text-sm text-muted-foreground bg-muted/50 p-3 rounded-lg">
              ...
              <ul className="space-y-0.5 text-xs">
                {loginType === 'user' && (
                  <li>• s201900001@kfupm.edu.sa (User)</li>
                )}
                {loginType === 'admin' && (
                  <li>• admin@kfupm.edu.sa (KFUPM Administrator)</li>
                )}
                {loginType === 'technical_admin' && (
                  <li>• maintenance@kfupm.edu.sa (Technical Admin)</li>
                )}
              </ul>
            </div>
