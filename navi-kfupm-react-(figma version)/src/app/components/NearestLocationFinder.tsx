...
export function NearestLocationFinder({ onLocationSelect }: NearestLocationFinderProps) {
  const [selectedCategory, setSelectedCategory] = useState<string>('');
  const [nearestLocations, setNearestLocations] = useState<Array<Location & { distance: number }>>([]);
