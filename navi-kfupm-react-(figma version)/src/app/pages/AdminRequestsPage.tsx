...
interface AdminRequest {
  ...
  title: string;
  description: string;
  requestType: 'Building Update' | 'Announcement' | 'Map Data' | 'Other';
  submittedBy: string;
...
export function AdminRequestsPage() {
  ...
  const handleStatusChange = (requestId: string, newStatus: AdminRequest['status']) => {
    setRequests(prev =>
      prev.map(req =>
        req.id === requestId
  ...
  const filterRequestsByStatus = (status?: AdminRequest['status']) => {
