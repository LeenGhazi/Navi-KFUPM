...
export function AccountPage() {
  ...
  return (
    <div className="container mx-auto py-6 px-4 h-full overflow-auto">
        ...
        <Tabs defaultValue={user.role === 'student' ? 'paths' : 'profile'} className="space-y-4">
          <TabsList
            className={`grid w-full ${
              user.role === 'student' ? 'grid-cols-2' : 'grid-cols-5'
            }`}
          >
            {user.role !== 'student' && (
              <>
                    ...
                    <div key={path.id} className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {path.rejectionReason && (
                          <p className="text-xs text-red-500 mt-1">Reason: {path.rejectionReason}</p>
                        )}
                        <Button
                          variant="outline"
                          className="mt-2"
