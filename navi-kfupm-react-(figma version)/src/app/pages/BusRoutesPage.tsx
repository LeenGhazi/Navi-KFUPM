...
export function BusRoutesPage() {
  const [selectedRoutes, setSelectedRoutes] = useState<string[]>(busRoutes.map(r => r.id));
              ...
              >
                ...
                <g transform="translate(20, 20)">
                  ...
                  {busRoutes.map((route, index) => (
                    <g key={route.id} transform={`translate(10, ${35 + index * 25})`}>
                      <line
                        x1="0"
                        y1="0"
                        x2="20"
                        ...
                        stroke={route.color}
                        strokeWidth="3"
                        opacity={selectedRoutes.includes(route.id) ? 1 : 0.3}
                      />
                      <text
                        x="25"
                        y="4"
                        fontSize="11"
                        fill="#374151"
                        opacity={selectedRoutes.includes(route.id) ? 1 : 0.5}
                      >
                        {route.name}
                      </text>
                    </g>
