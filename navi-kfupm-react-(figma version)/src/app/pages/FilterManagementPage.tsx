...
export function FilterManagementPage() {
  ...
  const [buildings] = useState<Location[]>(mockLocations);
  ...
  const openBuildingsDialog = (category: FilterCategory) => {
    setSelectedCategory(category);
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  ...
                  onClick={() => openBuildingsDialog(category)}
                >
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="value"
                placeholder="e.g., medical_center"
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            {selectedCategory && selectedCategory.buildingCount > 0 && (
