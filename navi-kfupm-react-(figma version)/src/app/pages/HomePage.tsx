...
export function HomePage() {
  ...
  const handleSubmitComment = (locationId: string) => {
    setSelectedLocationForAction(locationId);
    setShowCommentDialog(true);
  };

  const handleSubmitComplaint = (locationId: string) => {
    setSelectedLocationForAction(locationId);
    ...
    <div className="flex h-[calc(100vh-4rem)]">
          ...
          <div className="p-4 space-y-6">
            ...
            <div>
              <Button 
                ...
                onClick={() => setShowCommunityPaths(true)}
              >
      ...
      <div className="flex-1 relative">
        <CampusMap
          ...
          onBuildingMoved={handleCancelMoveBuilding}
        />
        {movingBuildingId && (
          <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-3">
            ...
            <Button
              size="sm"
              variant="secondary"
              onClick={handleCancelMoveBuilding}
              className="ml-2"
            >
              Cancel
            </Button>
      ...
      <LocationDetailsDialog
        ...
        onStartMoveBuilding={handleStartMoveBuilding}
      ...
      {selectedLocationForAction && (
        <>
          <AddCommentDialog
            locationId={selectedLocationForAction}
      ...
      <CommunityPathsDialog
        open={showCommunityPaths}
        onOpenChange={setShowCommunityPaths}
